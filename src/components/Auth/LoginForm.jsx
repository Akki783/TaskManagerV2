...
const Login = () => {
  ...
  return (
    <div className="w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center">
      {/* <h2>Login</h2> */}
      <form onSubmit={handleSubmit(onSubmit)} className="form-container w-full md:w-[400px] flex flex-col gap-y-8 bg-white px-10 pt-14 pb-14 shadow-xl/30">
        ...
        <Link to="/forgot-password" className='hover:text-blue-500 transition-colors duration-200'>Forgot Password?</Link>
