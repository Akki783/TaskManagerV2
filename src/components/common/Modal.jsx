...
function Modal({ register, handleSubmit, formState: { errors }, getValues, setOpenModal, setValue, onSubmit, editingTask }) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] !mt-0 grid place-items-center overflow-auto backdrop-blur-sm">
      <div className="w-11/12 max-w-[350px] rounded-lg  border-richblack-400 bg-richblack-800 p-6 bg-white shadow-2xl">
